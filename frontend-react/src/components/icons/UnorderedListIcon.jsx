...
const UnorderedListIcon = forwardRef(
  (
    ...
    const stop = useCallback(async () => {
      if (shouldReduceMotion) return;
      animate(".list-line-1", { scaleX: 1 }, { duration: 0.2, ease: "easeInOut" });
      animate(".list-line-2", { scaleX: 1 }, { duration: 0.2, ease: "easeInOut" });
      animate(".list-line-3", { scaleX: 1 }, { duration: 0.2, ease: "easeInOut" });
      animate(".list-bullets", { scale: 1 }, { duration: 0.2, ease: "easeInOut" });
    }, [animate, shouldReduceMotion]);
